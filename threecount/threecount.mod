...
var run_b = w1 + wk6 * (u - alpha6) + wk5 * (u - alpha5) + wk4 * (u - alpha4) + wk3 * (u - alpha3)+ wk2 * (u - alpha2) + ws * b_s; #branching algo when width based algo is not triggered
var run_w = 3^alpha; #width based algo
var run;
